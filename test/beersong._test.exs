defmodule BeerSongTest do
    ...
    describe "verse" do
	    ...
	    @tag :pending
	    test "verse with 99 bottles" do
	      assert BeerSong.verse(99) == \
	      	"99 bottles of beer on the wall, 99 bottles of beer.\n" <> \
			"Take one down and pass it around, 98 bottles of beer on the wall.\n"
	    end #test "verse with 99 bottles" do
	...
	describe "sing" do
	    ...
	    test "first two verses" do
	      assert BeerSong.sing(99,98) == """
	             ...
	             """
	    end #test "first two verses" do
	    
	    @tag :pending
	    test "last three verses" do
	      assert BeerSong.sing(2,0) == """
	             2 bottles of beer on the wall, 2 bottles of beer.
	             Take one down and pass it around, 1 bottle of beer on the wall.
	             ...
	             """
	    end #test "last three verses" do
	    
	    @tag :pending
	    test "all verses" do
	      assert BeerSong.sing(99,0) == """
	             99 bottles of beer on the wall, 99 bottles of beer.
	             Take one down and pass it around, 98 bottles of beer on the wall.
	             ...
	             """
	    end #test "all verses" do
    
	end #describe "sing" do
end